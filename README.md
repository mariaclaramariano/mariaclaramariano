...
Sou Analista de Dados com mais de 1 ano e meio de experiência em transformar dados em insights estratégicos e apoiar a tomada de decisão por meio de soluções baseadas em dados. Especialista em Power BI, SQL (PostgreSQL) e Python, com foco em automação de processos, modelagem de dados (relacional e dimensional) e desenvolvimento de dashboards interativos.
